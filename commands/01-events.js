...
.addEvent("messageReactionAdd", async (reaction, user) => {
  ...
  } else if ((message.channel.id == Module.config.channels.modlogs) && (reaction.emoji.name == "🔗") && (reaction.users.cache.filter(u => !user.bot).size == 1) && ((Date.now() - message.createdTimestamp) < (24 * 60 * 60 * 1000))) {
