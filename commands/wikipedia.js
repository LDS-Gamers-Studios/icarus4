...
.addCommand({name: "wikipedia",
  description: "Search Wikipedia for a term.",
  syntax: "Term",
  permissions: (msg) => (!msg.guild || (msg.channel.permissionsFor(msg.member).has(["EMBED_LINKS", "ATTACH_FILES"]) && msg.channel.permissionsFor(msg.client.user).has("EMBED_LINKS"))),
